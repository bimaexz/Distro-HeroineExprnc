...
<body>
    ...
    <section class="product-container">
        <!-- left side -->
        <div class="img-card">
            <img src="../user/assets/img/product4.jpg" alt="" id="featured-image">
            <!-- small img -->
            <div class="small-Card">
                <img src="../user/assets/img/product4.jpg" onclick="func()" alt="" class="small-Img">
                <img src="../user/assets/img/escape.jpg" alt="" class="small-Img">
            </div>
        </div>
        <!-- Right side -->
