...
<body>
    ...
    <section class="product-container">
        <!-- left side -->
        <div class="img-card">
            <img src="../user/assets/img/product3.jpg" alt="" id="featured-image">
            <!-- small img -->
            <div class="small-Card">
                <img src="../user/assets/img/product3.jpg" onclick="func()" alt="" class="small-Img">
                <img src="../user/assets/img/ramose1.jpg" alt="" class="small-Img">
                <img src="../user/assets/img/ramose2.jpg" alt="" class="small-Img">
                <img src="../user/assets/img/ramose3.jpg" alt="" class="small-Img">
            </div>
        </div>
        <!-- Right side -->
