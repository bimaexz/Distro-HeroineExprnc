...
<body>
    ...
    <section class="product-container">
        <!-- left side -->
        <div class="img-card">
            <img src="../user/assets/img/product2.jpg" alt="" id="featured-image">
            <!-- small img -->
            <div class="small-Card">
                <img src="../user/assets/img/product2.jpg" onclick="func()" alt="" class="small-Img">
                <img src="../user/assets/img/spasmodic1.jpg" alt="" class="small-Img">
                <img src="../user/assets/img/spasmodic2.jpg" alt="" class="small-Img">
