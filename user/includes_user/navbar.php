<nav class="navbar navbar-expand-lg bg-light fixed-top">
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <a href="profile.php">
                <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor"
                    class="bi bi-person-circle mx-3" viewBox="0 0 16 16">
            ...
            <!-- <div class="d-flex">
                <button class="btn font-weight-bold mx-3" data-bs-toggle="modal" data-bs-target="#loginModal"
                    style="border-color: black;">Masuk</button>
        ...
        <div class="modal-content rounded-4 shadow">
            ...
            <div class="modal-body p-5 pt-0">
                <form class="">
                    ...
                    <button class="w-100 mb-2 btn btn-lg rounded-3" style="background-color: black;color: white;"
