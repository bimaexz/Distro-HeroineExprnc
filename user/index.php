...
<head>
    ...
    <title>Heroine Exprnc Store</title>
        ...
        <div id="carouselExampleIndicators" class="carousel slide">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="../user/assets/img/slide1.png" class="d-block w-100" alt="...">
                    <a href="#contactform" class="carousel-caption d-none d-md-block">
                        <h5 class="btn btn-outline-light">Hubungi Kami</h5>
                    </a>
                </div>
                <div class="carousel-item">
                    <img src="../user/assets/img/slide2.png" class="d-block w-100" alt="...">
                    <a href="#contactform" class="carousel-caption d-none d-md-block">
                        <h5 class="btn btn-outline-light">Hubungi Kami</h5>
                    </a>
                </div>
                <div class="carousel-item">
                    <img src="../user/assets/img/slide3.png" class="d-block w-100" alt="...">
                    <a href="#contactform" class="carousel-caption d-none d-md-block">
                        <h5 class="btn btn-outline-light">Hubungi Kami</h5>
                    </a>
                </div>
    ...
    <section id="profile">
        <div class="row featurette">
            <div class="col-md-8 order-md-2">
                <h2 class="featurette-heading fw-normal lh-1">Profile <span class="text-body-secondary">Heroine Exprnc
                        Store</span></h2>
                <p class="">Kami sudah berdiri sejak tahun 2003, store kami
                    berada di Jl. Cengkeh No 20 Kav 1, Kota Malang. Asal nama HEROINE sendiri berasal dari gabungan kata
                    "hero" dan "in", hero yang berasal dari kata superhero dan in yang maknanya wanita. Jadi arti dari
                    brand heroine sendiri adalah Superhero Wanita. Kami menyediakan kebutuhan fashion streetware seperti
                    kaos, jaket, crewneck, dan aksesoris pendukung lainnya. Jam buka toko pada pukul 10.00 - 21.00 WIB
                </p>
            </div>
            <div class="col-md-4 order-md-1">
                <img src="../user/assets/img/logo2.png"
        ...
        <div class="container">
            <div class="row justify-content-center text-center">
                <div class="col-md-8 col-lg-6">
                    <div class="header">
                        <h3>Pilih Produk dan Gaya Fashion Anda</h3>
            ...
            <div class="row">
                <div class="col-md-6 col-lg-4 col-xl-3">
                    <div id="product-1" class="single-product">
                        <div class="part-1">
                            <ul>
                                <li><a href="detail-product-attract.php">
                        ...
                        <div class="part-2">
                            <a href="detail-product-attract.php">
                ...
                <div class="col-md-6 col-lg-4 col-xl-3">
                    <div id="product-2" class="single-product">
                        <div class="part-1">
                            ...
                            <ul>
                                <li><a href="detail-product-spasmodic.php">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                            fill="currentColor" class="bi bi-cart-plus" viewBox="0 0 16 16">
                                            <path
                                                d="M9 5.5a.5.5 0 0 0-1 0V7H6.5a.5.5 0 0 0 0 1H8v1.5a.5.5 0 0 0 1 0V8h1.5a.5.5 0 0 0 0-1H9V5.5z" />
                        ...
                        <div class="part-2">
                            <a href="detail-product-spasmodic.php">
                ...
                <div class="col-md-6 col-lg-4 col-xl-3">
                    <div id="product-3" class="single-product">
                        <div class="part-1">
                            <ul>
                                <li><a href="detail-product-ramose.php">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                            fill="currentColor" class="bi bi-cart-plus" viewBox="0 0 16 16">
                                            <path
                                                d="M9 5.5a.5.5 0 0 0-1 0V7H6.5a.5.5 0 0 0 0 1H8v1.5a.5.5 0 0 0 1 0V8h1.5a.5.5 0 0 0 0-1H9V5.5z" />
                        ...
                        <div class="part-2">
                            <a href="detail-product-ramose.php">
                ...
                <div class="col-md-6 col-lg-4 col-xl-3">
                    <div id="product-4" class="single-product">
                        <div class="part-1">
                            ...
                            <ul>
                                <li><a href="detail-product-escape.php">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                            fill="currentColor" class="bi bi-cart-plus" viewBox="0 0 16 16">
                                            <path
                                                d="M9 5.5a.5.5 0 0 0-1 0V7H6.5a.5.5 0 0 0 0 1H8v1.5a.5.5 0 0 0 1 0V8h1.5a.5.5 0 0 0 0-1H9V5.5z" />
                        ...
                        <div class="part-2">
                            <a href="detail-product-escape.php">
        ...
        <div class="modal-content rounded-4 shadow">
            ...
            <div class="modal-body p-5 pt-0">
                <form class="">
                    ...
                    <button class="w-100 mb-2 btn btn-lg rounded-3" type="submit"
                        style="background-color: black;color: white;">Masuk</button>
                    <smDenganall class="text-body-secondary">Belum memliki akun?</smDenganall><a href="" data-bs-toggle="modal" data-bs-target="#registerModal" style="color: blue;"> Daftar disini</a>
                    <hr class="my-4">
...
<div class="modal fade" id="registerModal" tabindex="-1" aria-labelledby="registerModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content rounded-4 shadow">
            ...
            <div class="modal-body p-5 pt-0">
                <form class="">
                    <label for="" style="margin-bottom: 10px;"><small>Sudah memiliki akun?<a href="" data-bs-toggle="modal" data-bs-target="#loginModal" style="color: blue;"> Login disini</a></small></label>
                    <div class="form-floating mb-3">
                    ...
                    <button class="w-100 mb-2 btn btn-lg rounded-3" style="background-color: black;color: white;" type="submit">Daftar</button>
                    <small class="text-body-secondary">Dengan mengklik Daftar, Anda menyetujui persyaratan penggunaan</small>
                    <hr class="my-4">
